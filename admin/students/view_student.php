    ...
    <div class="card card-outline card-navy shadow rounded-0">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <button class="btn btn-sm btn-navy bg-navy btn-flat" type="button" id="add_academic"><i class="fa fa-plus"></i> Add info</button>
            ...
            <div class="container-fluid" id="outprint">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label text-muted">Customer ID</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="pl-4">
                                <?php 
                                    switch ($status){
                                        case 0:
                                            echo '<span class="rounded-pill badge badge-secondary bg-gradient-secondary px-3">Not Interested</span>';
                                            break;
                                        case 1:
                                            echo '<span class="rounded-pill badge badge-primary bg-gradient-primary px-3">Interested</span>';
                                            break;
                                    }
                                ?>
                            </div>
                ...
                <fieldset class="border-bottom">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label text-muted">Date of Sign Up</label>
                                <div class="pl-4"><?= isset($dob) ? date("M d, Y",strtotime($dob)) : 'N/A' ?></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label text-muted">Customer Contact</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label text-muted">Location</label>
                                <div class="pl-4"><?= isset($present_address) ? $present_address : 'N/A' ?></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label text-muted">Property In Need Of</label>
                ...
                <fieldset>
                    <legend class="text-muted">Associated Information</legend>
                    <table class="table table-stripped table-bordered" id="academic-history">
                        ...
                        <thead>
                            <tr class="bg-gradient-dark">
                                ...
                                <th class="py-1 text-center">Department/PIN</th>
                                <th class="py-1 text-center">Property/Contact</th>
                                <th class="py-1 text-center">Region</th>
                                <th class="py-1 text-center">Feedback Status</th>
                                <th class="py-1 text-center">Transaction Status</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-1 align-middle text-center">
                                    ...
                                    switch($row['status']){
                                        case '1':
                                            echo '<span class="rounded-pill badge badge-primary px-3">Yes,Liked</span>';
                                            break;
                                        case '2':
                                            echo '<span class="rounded-pill badge badge-success px-3">No,Did not like</span>';
                                            break;
                                        case '3':
                                            echo '<span class="rounded-pill badge badge-warning px-3">Inspection done only</span>';
                                            break;
                                        case '4':
                                            echo '<span class="rounded-pill badge badge-default border px-3">Inspection Not Done</span>';
                                            break;
                                        default:
                                ...
                                <?php 
                                    switch($row['end_status']){
                                        case '0':
                                            ...
                                            break;
                                        case '1':
                                            echo '<span class="rounded-pill badge badge-success px-3">Paid</span>';
                                            break;
                                        case '2':
                                            echo '<span class="rounded-pill badge badgedefault bg-maroon px-3">Cancelled</span>';
                                            break;
                                    }
                                    ?>
                                </td>
...
<noscript id="print-header">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <h3 class="text-center"><b>Customer Records</b></h3>
        </div>
        <div class="col-2"></div>
    </div>
</noscript>
<script>
    $(function() {
        ...
        $('#add_academic').click(function(){
            uni_modal("Add Info Record for <b><?= isset($roll) ? $roll.' - '.$fullname : "" ?></b>","students/manage_academic.php?student_id=<?= isset($id) ? $id : "" ?>",'mid-large')
        })
        ...
        $('.delete_academic').click(function(){
			_conf("Are you sure to delete this Customer's info Record?","delete_info",[$(this).attr('data-id')])
		})
        $('#delete_student').click(function(){
			_conf("Are you sure to delete this Customer Information?","delete_customer",['<?= isset($id) ? $id : '' ?>'])
		})
        ...
        $('#print').click(function(){
            ...
            _el.append(_h)
            _el.append(_ph)
            _el.find('title').text('Customer Records - Print View')
            _el.append(_p)
