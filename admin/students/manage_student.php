...
<div class="content py-3">
    <div class="card card-outline card-primary shadow rounded-0">
        <div class="card-header">
            <h3 class="card-title"><b><?= isset($id) ? "Update Customer Details - ". $roll : "New Customer" ?></b></h3>
        </div>
        <div class="card-body">
                    ...
                    <fieldset class="border-bottom">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="roll" class="control-label">Customer ID</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="dob" class="control-label">Date of Sign Up</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="present_address" class="control-label">Location</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="permanent_address" class="control-label">Property In Need Of</label>
        ...
        <div class="card-footer text-right">
            <button class="btn btn-flat btn-primary btn-sm" type="submit" form="student_form">Save Customer Details</button>
