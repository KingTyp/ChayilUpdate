              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-header">Land</li>
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=Land/manage_land" class="nav-link nav-Land_manage_land">
                        <i class="nav-icon fas fa-plus"></i>
                        <p>
                          New Land
                        </p>
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=Land" class="nav-link nav-Land">
                    ...
                    <li class="nav-header">Houses</li>
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=Houses/manage_houses" class="nav-link nav-property_manage_houses">
                        <i class="nav-icon fas fa-plus"></i>
                        <p>
                          New House
                        </p>
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=Houses" class="nav-link nav-Houses">
                        <i class="nav-icon fas fa-building"></i>
                        <p>
                          Houses List
                        </p>
